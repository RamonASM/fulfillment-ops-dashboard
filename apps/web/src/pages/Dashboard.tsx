...
export default function Dashboard() {
  ...
  const { data: alertsData, isLoading: alertsLoading } = useQuery({
    ...
    queryFn: () =>
      api.get<{ data: AlertWithProduct[]; meta: { severityCounts: Record<string, number> } }>(
        '/alerts',
  ...
  const totals = clients.reduce(
    (acc, client) => ({
      ...
      critical: acc.critical + (client.stats?.criticalCount || 0) + (client.stats?.stockoutCount || 0),
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <div className="p-4 border-b border-border flex items-center justify-between">
            <h2 className="font-semibold text-gray-900">Alerts Requiring Attention</h2>
            <Link
              to="/alerts"
