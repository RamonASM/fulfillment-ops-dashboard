...
// Note: React components not exported from main index to avoid ESM issues in API.
// Web and Portal apps import directly from '@inventory/shared/components/help'
// -----------------------------------------------------------------------------
